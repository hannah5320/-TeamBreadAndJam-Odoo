...
function Departments() {
  ...
  const columns = [
    { header: 'Department Name', accessor: 'name', render: (row) => <strong>{row.name}</strong> },
    ...
    <div className="module-container">
      ...
      <div className="module-header">
        ...
        <Button variant="primary" onClick={() => navigate('/departments/create')}>
          <FiPlus style={{ marginRight: '8px', strokeWidth: 3 }} /> Add Department
        </Button>
      </div>
      ...
      <Table 
        ...
        actions={(row) => (
          <>
            <Button variant="secondary" onClick={() => navigate(`/departments/edit/${row.id}`)}>
              Edit
            </Button>
          </>
        )}
