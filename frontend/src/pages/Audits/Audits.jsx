  ...
  return (
    <div className="module-container">
      ...
      <div className="module-header">
        ...
        <Button variant="primary" onClick={() => navigate('/audits/create')}>
          <FiPlus style={{ marginRight: '8px', strokeWidth: 3 }} /> Create Audit
        </Button>
      </div>
      ...
      <Table 
        ...
        data={data}
        loading={loading}
        emptyMessage="No audits registered yet"
        actions={(row) => (
          <>
            <Button variant="secondary" onClick={() => navigate(`/audits/${row.id}`)}>
              Verify Assets
            </Button>
